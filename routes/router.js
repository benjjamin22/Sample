...
router.get('/', function(req, res, next) {
  ...
  var schools = path.join(process.cwd(),'./schools copy.json')
  ...
  router.post('/login', function handler(req, res,next) {
    ...
    try{
        ...
        var foundUser = accounts.find((data) => id === data._id);
  ...
  router.post('/search', async (req,res) => {
    try{
        ...
        //req.session.user = foundUser.pine;
            ...
            res.render('searchresult',{data:foundUser});
...
router.get('/schools', function(req, res, next) {
  ...
  router.get('/:id', function (req, res,next) {
    ...
    router.get('/briopi/:id', function (req, res,next) {
    try{
        var id = req.params.id;
        var foundUser = accounts.find((data) => id === data._id);
        console.log(foundUser);
      ...
      router.get('/briop/:id', function (req, res,next) {
    try{
        var id = req.params.id;
        var foundUser = accounts.find((data) => id === data._id);
        console.log(foundUser);
